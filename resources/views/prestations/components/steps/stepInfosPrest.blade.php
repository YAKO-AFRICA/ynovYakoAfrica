        ...
        <div class="card-body">
            <div class="etapePrest" id="etapePrest1">
                <div class="row g-3 mb-3">
                    <div class="col-12 col-lg-6">
                        <label for="single-select-field" class="form-label">Pour quel Contrat demandez-vous la
                            prestation ? <span class="star">*</span></label>
                        <select class="form-select" name="idcontrat" id="single-select-field"
                            data-placeholder="Veuillez sélectionner l'ID du contrat" required>
                            <option></option>
                    ...
                    <div class="col-12 col-lg-6">
                        <label for="montant" class="form-label">Quel est le montant que vous souhaitez demander ? <span
                                class="star">*</span></label>
                        <input type="number" class="form-control" min="0" name="montantSouhaite"
                            id="montantSouhaite" placeholder="Saisir le montant souhaité" required disabled>
                ...
                <div class="row ">
                    <div class="col-6 d-flex justify-content-start gap-3">
                        <button class="btn btn-primary px-4" type="button" onclick="stepper1.previous()"><i
                                class='bx bx-left-arrow-alt me-2 fs-4'></i>Retour étape 1</button>
                    </div>
                ...
                <div class="row g-3 mb-3 text-center">
                    ...
                    <div class="row d-flex justify-content-center align-items-center mt-3 gap-3">
                        <div class="moyenPaiement-option col-lg-3 col-md-4 col-sm-12">
                            <input type="checkbox" name="moyenPaiement" value="Mobile_Money" id="mobileMoney"
                                class="moyenPaiement-input">
                        ...
                        <div class="moyenPaiement-option col-lg-3 col-md-4 col-sm-12">
                            <input type="checkbox" name="moyenPaiement" value="Virement_Bancaire" id="virementBancaire"
                                class="moyenPaiement-input">
                ...
                <div class="row ">
                    ...
                    <div class="col-6 d-flex justify-content-end gap-3">
                        <button class="btn btn-primary next-btn" type="button" id="next-stepper3"
                            data-next="etapePrest3">
                            Suivant <i class='bx bx-right-arrow-alt fs-4'></i>
                        </button>

                        <button class="btn btn-primary next-btn" type="button" id="next-stepper4"
                            data-next="etapePrest4">
                            Suivant <i class='bx bx-right-arrow-alt fs-4'></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="etapePrest d-none" id="etapePrest3">
                <div class="row g-3 mb-3 text-center" id="Operateur">
                    ...
                    <div class="row d-flex justify-content-center align-items-center mt-3 gap-3">
                        <div class="Operateur-option col-lg-3 col-md-4 col-sm-12">
                            <input type="radio" name="Operateur" value="Orange_money" id="Orange"
                        ...
                        <div class="Operateur-option col-lg-3 col-md-4 col-sm-12">
                            ...
                            <label for="MTN"
                                class="Operateur-label d-flex flex-column align-items-center justify-content-center">
                                <span class="Operateur-icon">
                                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLJi9U1dG-aKqZeuCTBrHUvMX8IpAcxqpp1A&s"
                                        alt="MTN Money">
                                </span>
                ...
                <div class="row" id="Operateur-btn">
                    ...
                    <div class="col-6 d-flex justify-content-end gap-3">
                        <button class="btn btn-primary next-btn" id="nextPhone" type="button"
                            data-next="etapePrest4">
                            Suivant <i class='bx bx-right-arrow-alt fs-4'></i>
                        </button>
                    </div>
            ...
            <div class="etapePrest d-none" id="etapePrest4">
                <div class="row g-3 mb-3" id="TelephonePaiement">
                    <div class="col-12 col-lg-6">
                        <label for="TelPaiement" class="form-label">N° de téléphone sur lequel vous souhaitez recevoir
                            le paiement <span class="star">*</span></label>
                        <input type="number" class="form-control" name="TelPaiement" id="TelPaiement"
                            placeholder="Veuillez saisir le N° de téléphone sur lequel vous souhaitez recevoir le paiement">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label for="ConfirmTelPaiement" class="form-label">Confirmer le N° de téléphone <span
                                class="star">*</span></label>
                        <input type="number" class="form-control" name="ConfirmTelPaiement" id="ConfirmTelPaiement"
                            placeholder="Veuillez resaisir le N° de téléphone sur lequel vous souhaitez recevoir le paiement">
                    </div>
                    <small><span class="form-label star"><i>Veuillez préciser l'indicatif du pays sans le
                                (<strong>+</strong>) et sans espace (ex: <strong>2250100128271</strong>)
                            </i></span></small>
                </div>
                <div class="row g-3 mb-3" id="IBANPaiement">
                    <div class="col-12 col-lg-6">
                        <label for="IBAN" class="form-label">IBAN sur lequel vous souhaitez recevoir le paiement
                    ...
                    <div class="col-12 col-lg-6">
                        <label for="ConfirmIBAN" class="form-label">Confirmer l'IBAN <span
                                class="star">*</span></label>
                        <input type="text" class="form-control" name="ConfirmIBAN" id="ConfirmIBAN"
                            placeholder="Veuillez resaisir l'IBAN sur lequel vous souhaitez recevoir le paiement">
                    </div>
                    <small><span class="form-label star"><i>Veuillez saisir l'IBAN de votre compte courant
                            </i></span></small>
                </div>
                <div class="row g-3 mb-3">
                    <div class="col-12">
                        <label for="AutresInfos" class="form-label">Avez-vous d'autres informations suplementaires a
                            fournir pour votre demande ? (<span class="star">max 400 caractères </span>)</label>
            ...
            <div class="etapePrest d-none" id="etapePrest5">
                <div class="row g-3 mb-3 text-center" id="OTP">
                    <span class="form-label">Un code de confirmation a été envoyé pas SMS, veuillez le rentrer
                        ci-dessous</span>
