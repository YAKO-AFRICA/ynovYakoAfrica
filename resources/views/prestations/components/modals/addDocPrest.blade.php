        ...
        <div class="modal-content">
            ...
            <form action="{{ route('prestation.add.docPrest') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                        ...
                        @if ($types['Police'] == null || $types['bulletin'] == null || $types['AttestationPerteContrat'] == null || $types['CNI'] == null || $types['FicheIDNum'] == null || $types['RIB'] == null || $types['Signature'] == null)
                            <div class="row g-3">
                                                ...
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="typeFile" class="form-select" id="typeFile" required>
                                                            <option value="" selected>Veuillez sélectionner le type de document</option>
                                        ...
                                        @if($prestation->moyenPaiement == 'Mobile_Money')
                                            ...
                                            <div class="col-xl-9 mx-auto">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            <label class="form-label">Fiche d'identification du n° de telephone avec le
                                                                caché de l'opérateur téléphonique<small> <strong>(Ou la capture d'écran
                                                                        de la vérification par la syntaxe)</strong></small></label>
                                                            <div class="input-group">
                                                                <input id="FicheID-file-uploa" class="form-control" type="file"
                                                                    name="libelle[]" accept=".jpg, .png, image/jpeg, image/png, .pdf"
                                                                    onchange="previewFilesPrest(event, 'previewFicheIDNum')" required>
                ...
                <div class="modal-footer">
                    @if ($types['Police'] == null || $types['bulletin'] == null || $types['AttestationPerteContrat'] == null || $types['CNI'] == null || $types['FicheIDNum'] == null || $types['RIB'] == null || $types['Signature'] == null)
                        <button type="submit" class="btn btn-success px-4">Submit <i class='bx bx-check'></i></button>
                    @endif
