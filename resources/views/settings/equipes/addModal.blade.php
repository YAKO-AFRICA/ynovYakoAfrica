<div class="modal fade " id="addnewEquipe" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="margin-top:0; margin-right: 0">
        <div class="modal-content">
            ...
            <form action="{{ route('setting.equipe.store') }}" method="POST" class="submitForm">
                @csrf
                        ...
                        <fieldset class="border p-3">
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <input type="text" id="libelle" name="libelleequipe" class="form-control" required>
                                </div>
