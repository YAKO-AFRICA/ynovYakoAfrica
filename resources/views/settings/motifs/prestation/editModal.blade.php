<div class="modal fade " id="EditMotif{{ $item->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="margin-top:0; margin-right: 0">
        <div class="modal-content">
            ...
            <form action="{{ route('setting.motifRejetPrestation.update', $item->id) }}" method="POST" class="submitForm">
                @csrf
                    ...
                    <fieldset class="border p-3">
                        ...
                        <div class="row">
                            <div class="mb-3 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <textarea name="libelle" id="libelle" class="form-control" required cols="30" rows="5">{{ $item->libelle }}</textarea>
                                {{-- <input type="text" id="libelle" name="libelle" value="" class="form-control" required> --}}
                            </div>
                        </div>
                    </fieldset>
                </div>
