...
<body>
    <div class="container">
        ...
        <div class="cards-grid" id="cardsGrid">
            <!-- OPTION 1 - COMPLÈTE -->
            <div class="card card-complete recommended" data-formule="complete" data-prime="9672" data-capital="7000000">
                ...
                <div class="card-detail">
                    ...
                    <div class="card-detail-content">
                        <ul>
                            <li><i class="fas fa-check-circle"></i> <strong>Couverture totale :</strong> 7 000 000 CFA</li>
                            <li><i class="fas fa-check-circle"></i> <strong>Bénéficiaires :</strong> Adhérent + Conjoint + Enfants (5 max) + 2 Ascendants</li>
                            ...
                            <li><i class="fas fa-check-circle"></i> <strong>Assistance :</strong> 24h/24, 7j/7</li>
                        </ul>
                    </div>
                </div>
                <div class="card-total">
                    <div>
                        ...
                        <div class="total-amount">7 000 000 CFA <span>(2 ascendants)</span></div>
                    </div>
            ...
            <!-- OPTION 2 - PREMIUM -->
            <div class="card card-premium" data-formule="premium" data-prime="7652" data-capital="6000000">
                <div class="card-header">
                ...
                <div class="card-detail">
                    ...
                    <div class="card-detail-content">
                        <ul>
                            <li><i class="fas fa-check-circle"></i> <strong>Couverture totale :</strong> 6 000 000 CFA</li>
                            <li><i class="fas fa-check-circle"></i> <strong>Bénéficiaires :</strong> Adhérent + Conjoint + Enfants (5 max) + 1 Ascendant</li>
                            <li><i class="fas fa-check-circle"></i> <strong>6ᵉ enfant :</strong> +500 CFA/mois par enfant supplémentaire</li>
                            <li><i class="fas fa-check-circle"></i> <strong>Délai de carence :</strong> Aucun (immédiat)</li>
                            <li><i class="fas fa-check-circle"></i> <strong>Validité :</strong> 12 mois renouvelable</li>
                ...
                <div class="card-total">
                    <div>
                        <span class="total-label">Total garanti</span>
                        <div class="total-amount">6 000 000 CFA <span>(1 ascendant)</span></div>
                    </div>
                    <button class="btn-select" onclick="selectOption(this)">Choisir</button>
                </div>
            </div>
        ...
        <div class="info-banner">
            ...
            <div>Toutes les formules couvrent jusqu'à <strong>5 enfants</strong>. À partir du <strong>6ᵉ enfant</strong>, une prime supplémentaire de <strong>500 CFA/mois</strong> par enfant est appliquée.</div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="3">5 enfants inclus, +500 CFA/mois dès le 6ᵉ</td>
                    </tr>
                    <tr>
