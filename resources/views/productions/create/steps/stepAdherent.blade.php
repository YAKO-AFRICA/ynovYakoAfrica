    ...
    <fieldset class="border p-3">
        ...
        <div class="row my-3">
            ...
            <div class="col-6">
                ...
                <input type="tel" name="telephone" class="form-control" id="contactsecondaire" placeholder="+225 00 00 00 00" required minlength="10" maxlength="14" autocomplete="on" pattern="[0-9]{10}">
            </div>
