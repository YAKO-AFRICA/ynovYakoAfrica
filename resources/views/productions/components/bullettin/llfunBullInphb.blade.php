            ...
            <div class="logo-Soutien" style="width: 100%; overflow: hidden;">
                ...
                <div style="width: 75%; float: left; text-align: center;">
                    ...
                    <div style="width: 30%; font-size: 10px; font-weight: bold; text-align: center; display: flex; justify-content: end; align-items: center; float: right; margin-top : -25px;">
                        <span style="margin: 0;">Numero :</span> <span style="margin: 0; color: white">{{ $contrat->numBullettin ?? '' }}</span>
                    </div>
                </div>
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 12px; text-align: center; margin: 0">
                    <thead>
                        <tr>
                            ...
                            {{-- <td style=" border: 1px solid #000;">Garantie complementaire</td> --}}
                    ...
                    <tbody>
                        <tr>
                            <td style="width: 50%; border: 1px solid #000;">{{ number_format($contrat->capital, 0) ?? '' }}</td>
                            <td style="width: 50%; border: 1px solid #000;">{{ number_format($contrat->primepricipale, 0) ?? '' }}</td>
                            {{-- <td style="width: 50%; border: 1px solid #000;">{{ number_format($contrat->primepricipale, 0) ?? '' }}</td> --}}
                            <td style="width: 50%; border: 1px solid #000;">{{ number_format($contrat->surprime, 0) ?? '' }}</td>
                            <td style="width: 50%; border: 1px solid #000;">{{ number_format($contrat->prime, 0) ?? '' }}</td>
                        </tr>
                    </tbody>
