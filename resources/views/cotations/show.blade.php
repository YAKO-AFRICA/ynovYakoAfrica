...
<div class="d-flex justify-content-end my-4">
    <div class="btn-group gap-1 gap-md-2 gap-lg-3">
        {{-- Actions --}}
        <div class="text-end">
            <a href="{{ route('cotation.index') }}" class="btn btn-secondary">
...
<div class="row">
            ...
            <div class="card-body">
                ...
                <div class="fm-menu">
                    <div class="list-group list-group-flush">
                        <a href="javascript:;" class="list-group-item py-1 btn border-0" data-target="info-cotation">
                            <i class='bx bx-folder me-2'></i><span>Détails de la cotation</span>
                        </a>
    ...
    <div class="col-12 col-lg-9">
        <div class="card">
            <div class="card-body">
                ...
                <section id="info-cotation" class="section-content">
                    <h5 class="mb-3">Détails de la cotation</h5>
                    ...
                    <div class="card shadow-sm p-4">
                        <div class="row g-3">
                            ...
                            {{-- Code --}}
                            <div class="col-md-4">
                                <label class="form-label text-muted">Code cotation</label>
                                <div class="fw-bold">{{ $cotation->code }}</div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    @if ($cotation->status == 'sending')
                                        <span class="badge bg-info">Demande envoyée</span>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fw-bold">
                                    {{ $cotation->created_at?->format('d/m/Y H:i') }}
                                </div>
                            </div>
                            ...
                            {{-- Souscripteur --}}
                            <div class="col-md-6">
                                <label class="form-label text-muted">Souscripteur</label>
                                <div class="fw-bold">
                                    {{ $cotation->nomCompletSouscripteur }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-bold">
                                    {{ $cotation->telephoneSouscripteur }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="fw-bold">
                                    {{ $cotation->autheur ?? 'Non renseigné' }}
                                </div>
                            </div>
                            ...
                            {{-- Note --}}
                            <div class="col-12">
                                <label class="form-label text-muted">Note / Observation</label>
                                <div class="border rounded p-3 bg-light">
                                    {{ $cotation->note ?: 'Aucune note disponible' }}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @include('cotations.partials.editModal')
