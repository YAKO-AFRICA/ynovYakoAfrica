<div id="partnerModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button type="button" class="close-modal" onclick="closePartnerModal()">×</button>
        </div>
        <style>
        ...
        <div class="modal-body">
            <div class="form-grid">
                <fieldset class="mt-3 p-3">
                    <legend class="float-none w-auto px-2 border rounded bg-white">
                        <small>Type de Partenaire</small>
                    </legend>
                    <div class="form-group">
                        <label class="required">Type de Partenaire</label>
                        <div class="cards-container row">
                            <label class="partner-card col" id="card-ass">
                                <input type="radio" name="partner_type" value="ASS">
                                Assuré
                            </label>
                            
                            <label class="partner-card col" id="card-ben">
                                <input type="radio" name="partner_type" value="BEN" class="BEN">
                                Bénéficiaire
                            </label>
                        </div>
                    </div>
            ...
            <div style="margin-top: 20px; text-align: right;">
                <button type="button" class="btn btn-secondary" onclick="closePartnerModal()" style="margin-right: 10px;">
                    Annuler
                </button>
