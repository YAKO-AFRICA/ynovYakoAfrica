...
var swiper = new Swiper('.swiper-container-brand', {
    slidesPerView: 5, // Nombre d'images visibles en même temps
    spaceBetween: 30, // Espace entre les images
    loop: true, // Boucle infinie
    autoplay: {
        delay: 0, // Aucune attente entre les slides
        disableOnInteraction: false // Continuer le défilement même après une interaction
    },
    speed: 3000, // Vitesse du défilement en millisecondes (plus c'est bas, plus c'est rapide)
    breakpoints: {
        640: {
            slidesPerView: 2,
            spaceBetween: 20
