...
//         return isValid;
//     }
//     // Fonction pour valider les champs de IBAN
//     function validateIbanFields() {
...
//     // Fonction pour démarrer le compte à rebours pour l'expiration de l'OTP
//     let otpExpirationTime = 5 * 60; // 5 minutes en secondes
//     let otpInterval;
...
//             if (montantSouhaite > moitieCapital || montantSouhaite <= 0) {
//                 alert(`Le montant souhaité doit être supérieur à 0 et inferieur ou égal à ${moitieCapital} FCFA.`);
//                 msgError.text(`Le montant souhaité doit être supérieur à 0 et inferieur ou égal à ${moitieCapital} FCFA.`).show();
//                 // ajouter une bordure rouge si le montant souhaité est invalide
//                 montantSouhaiteField.classList.add('is-invalid');
//                 montantSouhaiteField.classList.remove('is-valid');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // document.querySelector('.prev-step-btn').addEventListener('click', function (event) {
    //     event.preventDefault(); // Empêche l'action par défaut du bouton
...
//                                                 `<a href="/espace-client/details-prestation/${prestation.code}" class="mx-3"><i class='bx bxs-show'></i></a>` :
//                                                 `<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal${prestation.code}" class="mx-3"><i class='bx bxs-show'></i></a>`
//                                             }
//                                         </div>
//                                     </td>
//                                 </tr>
